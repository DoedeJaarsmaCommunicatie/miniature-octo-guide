...
final class Cb5_elements_users {
	const VERSION = '1.0.0';
...
//		Check Elementor Version
	...
	public function includes() {
		...
		require_once __DIR__ . '/widget/class-cb5_elements_users-widget.php';
...
//		Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Cb5\Elementor\Widgets\Users\cb5_users_widget() );
...
//	    Include control file
		require_once __DIR__ . '/control/user-widget.php';

//	    Register controller
		\Elementor\Plugin::instance()->controls_manager->register_control( 'control-type-', 'NEW');
